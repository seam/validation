...
public class InjectingConstraintValidatorFactoryTest
{
   ...
   public static JavaArchive createTestArchive() throws Exception
   {
      return ShrinkWrap.create(JavaArchive.class, "test.jar").
         ...
         addAsManifestResource(new File("src/test/resources/META-INF/services/org.jboss.seam.solder.beanManager.BeanManagerProvider")).
    ...
    * <p>
    * In this case the {@link BeanManager} used in <code>InjectingConstraintValidatorFactory</code> is obtained via
    * {@link BeanManagerLocator}, but no <code>BeanManager</code> can be found there. An exception is expected in
    * this case as <code>InjectingConstraintValidatorFactory</code> can't be used without a bean manager.
    * </p>
    * 
    * @see SEAMVALIDATE-14
    */
